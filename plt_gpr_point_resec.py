...
filename = r"C:\Users\ReSEC2021\OneDrive - Wilfrid Laurier University\slideanalysis\gpr_m.csv"
...
x2 = df['Lat_Long']
print(x)
p0 = plt.scatter(x2, y, label = 'Measured',marker='s',color = 'red')
#p1 = plt.scatter(x2, y1, label = 'Simulated')
p1 = plt.plot(x2, y1,label = 'Simulated')
...
plt.title('GPR Data vrs Model Output (17- 02- 2020)')
...
rmse = "RMSE : 7.24"
mbe = "MBE : -5.64"
plt.text("(65.22,-122.99)", 85, rmse)
plt.text("(65.22,-122.99)", 81, mbe)
